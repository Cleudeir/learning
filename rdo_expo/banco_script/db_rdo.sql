...
-- Schema DB_RDO
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `DB_RDO` ;
USE `DB_RDO` ;

-- -----------------------------------------------------
-- Table `DB_RDO`.`EMPRESAS`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `DB_RDO`.`EMPRESAS` ;
...
-- Table `DB_RDO`.`OBRAS`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `DB_RDO`.`OBRAS` ;
...
-- Table `DB_RDO`.`FUNCAO`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `DB_RDO`.`FUNCAO` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `DB_RDO`.`FUNCIONARIOS` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `DB_RDO`.`CATEGORIA` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `DB_RDO`.`EQUIPAMENTOS` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `DB_RDO`.`OBRAS_EMPRESAS` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `DB_RDO`.`FRENTES` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `DB_RDO`.`RDO_FUNCIONARIOS` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `DB_RDO`.`RDO_EQUIPAMENTOS` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `DB_RDO`.`USUARIOS` ;
...
-- -----------------------------------------------------
-- Table `DB_RDO`.`USUARIOS_OBRAS`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `DB_RDO`.`USUARIOS_OBRAS` ;

CREATE TABLE IF NOT EXISTS `DB_RDO`.`USUARIOS_OBRAS` (
  `uid` VARCHAR(30) NOT NULL,
  `obraId` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`uid`, `obraId`),
  INDEX `fk_USUARIOS_has_OBRAS_OBRAS1_idx` (`obraId` ASC) VISIBLE,
  INDEX `fk_USUARIOS_has_OBRAS_USUARIOS1_idx` (`uid` ASC) VISIBLE,
  CONSTRAINT `fk_USUARIOS_has_OBRAS_USUARIOS1`
    FOREIGN KEY (`uid`)
    REFERENCES `DB_RDO`.`USUARIOS` (`uid`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
