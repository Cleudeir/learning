...
export function initModels(sequelize) {
  ...
  EMPRESAS.belongsToMany(OBRAS, {
    as: "obraId_OBRAS",
    through: OBRAS_EMPRESAS,
    foreignKey: "empresaId",
    otherKey: "obraId",
  });
  EQUIPAMENTOS.belongsToMany(FUNCIONARIOS, {
    as: "funcionarioId_FUNCIONARIOS",
    through: RDO_EQUIPAMENTOS,
    foreignKey: "equipamentoId",
    otherKey: "funcionarioId",
  });
  FUNCIONARIOS.belongsToMany(EQUIPAMENTOS, {
    as: "equipamentoId_EQUIPAMENTOS",
    through: RDO_EQUIPAMENTOS,
    foreignKey: "funcionarioId",
    otherKey: "equipamentoId",
  });
  OBRAS.belongsToMany(EMPRESAS, {
    as: "empresaId_EMPRESAS",
    through: OBRAS_EMPRESAS,
    foreignKey: "obraId",
    otherKey: "empresaId",
  });
  OBRAS.belongsToMany(USUARIOS, {
    as: "uid_USUARIOS",
    through: USUARIOS_OBRAS,
    foreignKey: "obraId",
    otherKey: "uid",
  });
  USUARIOS.belongsToMany(OBRAS, {
    as: "obraId_OBRAS_USUARIOS_OBRAS",
    through: USUARIOS_OBRAS,
    foreignKey: "uid",
    otherKey: "obraId",
  });
  EQUIPAMENTOS.belongsTo(CATEGORIA, {
    as: "categorium",
    foreignKey: "categoriaId",
  });
  CATEGORIA.hasMany(EQUIPAMENTOS, {
    as: "EQUIPAMENTOS",
    foreignKey: "categoriaId",
  });
  EQUIPAMENTOS.belongsTo(EMPRESAS, { as: "empresa", foreignKey: "empresaId" });
  EMPRESAS.hasMany(EQUIPAMENTOS, {
    as: "EQUIPAMENTOS",
    foreignKey: "empresaId",
  });
  ...
  OBRAS_EMPRESAS.belongsTo(EMPRESAS, {
    as: "empresa",
    foreignKey: "empresaId",
  });
  EMPRESAS.hasMany(OBRAS_EMPRESAS, {
    as: "OBRAS_EMPRESAS",
    foreignKey: "empresaId",
  });
  RDO_EQUIPAMENTOS.belongsTo(EQUIPAMENTOS, {
    as: "equipamento",
    foreignKey: "equipamentoId",
  });
  EQUIPAMENTOS.hasMany(RDO_EQUIPAMENTOS, {
    as: "RDO_EQUIPAMENTOS",
    foreignKey: "equipamentoId",
  });
  RDO_EQUIPAMENTOS.belongsTo(FRENTES, { as: "frente", foreignKey: "frenteId" });
  FRENTES.hasMany(RDO_EQUIPAMENTOS, {
    as: "RDO_EQUIPAMENTOS",
    foreignKey: "frenteId",
  });
  RDO_FUNCIONARIOS.belongsTo(FRENTES, { as: "frente", foreignKey: "frenteId" });
  FRENTES.hasMany(RDO_FUNCIONARIOS, {
    as: "RDO_FUNCIONARIOS",
    foreignKey: "frenteId",
  });
  ...
  RDO_EQUIPAMENTOS.belongsTo(FUNCIONARIOS, {
    as: "funcionario",
    foreignKey: "funcionarioId",
  });
  FUNCIONARIOS.hasMany(RDO_EQUIPAMENTOS, {
    as: "RDO_EQUIPAMENTOS",
    foreignKey: "funcionarioId",
  });
  RDO_FUNCIONARIOS.belongsTo(FUNCIONARIOS, {
    as: "funcionario",
    foreignKey: "funcionarioId",
  });
  FUNCIONARIOS.hasMany(RDO_FUNCIONARIOS, {
    as: "RDO_FUNCIONARIOS",
    foreignKey: "funcionarioId",
  });
  ...
  OBRAS.hasMany(RDO_EQUIPAMENTOS, {
    as: "RDO_EQUIPAMENTOS",
    foreignKey: "obraId",
  });
  RDO_FUNCIONARIOS.belongsTo(OBRAS, { as: "obra", foreignKey: "obraId" });
  OBRAS.hasMany(RDO_FUNCIONARIOS, {
    as: "RDO_FUNCIONARIOS",
    foreignKey: "obraId",
  });
